    ...
    <div class="main">
      ...
      <div class="content">
        ...
        <div class="home-hero-grid">
          ...
          <div class="card" style="padding:24px;position:relative;overflow:hidden;" data-testid="card-month-summary">
            ...
            <div style="position:relative;">
              <div class="label-xs">Budget · May 2026</div>
              <div class="display" style="font-size:56px;margin-top:8px;">
          ...
          <div class="card" style="padding:20px;background:var(--mint);" data-testid="card-income">
            <div class="row-between">
              <div class="label-xs">Income · May</div>
              <AppIcon name="arrow-down-left" :size="18" />
            </div>
            <div class="display" style="font-size:36px;margin-top:10px;">
          ...
          <div class="card" style="padding:20px;background:var(--coral);" data-testid="card-spending">
            <div class="row-between">
              <div class="label-xs">Spending · May</div>
        ...
        <div class="row-between" style="margin-bottom:14px;">
          <div>
            <div class="label-xs">Categories</div>
            <div style="font-family:var(--font-display);font-weight:700;font-size:22px;">Budget progress</div>
          </div>
          ...
          <div class="home-cat-grid">
            ...
            >
              <div class="row-between" style="margin-bottom:10px;">
                ...
                <div class="mono" style="font-size:12px;color:var(--ink-mute);"
